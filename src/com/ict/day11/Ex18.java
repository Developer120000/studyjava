...
public class Ex18 {
	public static void main(String[] args) {
		// 날짜 관련 클래스
		// 1. Date 클래스			(1.0버전에 나옴)
		// 2. Calendar 클래스		(5.0버전)
		// 3. LocalDate 클래스		(9.0버전)
		...
		// 년, 월, 일, 시, 분, 초, 요일  => 시스템상의 년,월,일,시,분,초   // 현재년도 - 1900 = 124
		System.out.println(date.getYear()+1900+"년"); // 1900년 1월 1일 오전 12시 부터 계산된다.
		System.out.println(date.getMonth() + 1); // 0 - 11 까지라 +1 을 해줘야 현재 월이 나온다.
