...
public class Ex11_Main {
	public static void main(String[] args) {
		...
		System.out.println("3. customer 테이블 데이터 삽입하기");
		System.out.println("4. customer 테이블 데이터 삭제하기");
		System.out.println("5. customer 테이블 데이터 수정하기");
		System.out.print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>");
		...
		case 2:
			...
			break;
		case 3: 
			System.out.println("삽입 정보 입력하세요");
			System.out.print("번호 : ");
